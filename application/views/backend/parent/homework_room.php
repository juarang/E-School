	                    ...
	                    <div class="col-sm-8">
		                    <div class="pipeline white lined-primary shadow">
			                    ...
			                    <div class="b-t padded-v-big">
				                    <?php echo getEduAppGTLang('file');?>: <a class="btn btn-rounded btn-sm btn-primary text-white" href="<?php echo base_url() . 'public/uploads/homework/' . $row['file_name']; ?>"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo $row['file_name'];?></a>
			                    </div>
			                    <?php endif;?>
