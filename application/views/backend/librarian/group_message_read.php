            ...
            <?php echo form_open(base_url() . 'librarian/group/send_reply/' . $current_message_thread_code, array('enctype' => 'multipart/form-data')); ?>
                ...
                <div class="chat-input-extra">
                    <div class="chat-extra-actions">
                        <input type="file" name="attached_file_on_messaging" id="file-3" class="inputfile inputfile-3 hidde"/>
                    ...
                    <?php if($img['file_type'] == "png" || $img['file_type'] == "jpg" || $img['file_type'] == "JPEG" || $img['file_type'] == "GIF"):?>
    					<li>
						    <a href="<?php echo base_url();?>public/uploads/group_messaging_attached_file/<?php echo $img['attached_file_name']; ?>">
    					        <img src="<?php echo base_url();?>public/uploads/group_messaging_attached_file/<?php echo $img['attached_file_name']; ?>" class="attached-file">
							</a>
						</li>
				    <?php endif;?>
				    <?php endforeach;?>
