                                ...
                                <?php if($query->num_rows() <= 0):?>
                                    <div class="ui-block paddingtel">
                                        ...
                                        <article class="hentry post">
                                            ...
                                            <div class="control-block-button post-control-button">
                                                <a href="javascript:void(0);" class="controlsbt btn btn-control" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getEduAppGTLang('polls');?>">
                                ...
                                <?php if($query->num_rows() > 0):?>
                                    <div class="ui-block paddingtel">
                                        <article class="hentry post">
                                            ...
                                            <div class="control-block-button post-control-button">
                                                <a href="javascript:void(0);" class="btn btn-control grbg2 text-white" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getEduAppGTLang('polls');?>">
                                                    <i class="picons-thin-icon-thin-0385_graph_pie_chart_statistics"></i>
                                                </a>
                                            </div>
                                            <div class="wall-content">
                                ...
                                <div class="sidebar__inner">
                                    ...
                                    <div class="ui-block paddingtel">
                                        ...
                                        <center>
                                            ...
                                            <a href="<?php echo base_url();?>librarian/birthdays/" class="birthdays-btn"><?php echo getEduAppGTLang('view_all_birthdays');?></a>
                                        </center>
                                        <div class="header-spacer"></div>
                                    </div><br>
                                    <br>
    ...
    <script src="<?php echo base_url();?>public/style/js/librarian_panel.js"></script>