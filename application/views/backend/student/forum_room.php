                                        ...
                                        <tr>
                                            ...
                                            <td class="posts">
                                                ...
                                                <?php if($row['file_name'] != ""):?>
                                                    <?php echo getEduAppGTLang('file');?>: <a class="btn btn-rounded btn-sm btn-primary" href="<?php echo base_url();?>public/uploads/forum/<?php echo $row['file_name'];?>" class="text-white"><i class="os-icon       picons-thin-icon-thin-0042_attachment"></i> <?php echo $row['file_name'];?></a>
                                                <?php endif;?>
                                            </td>
                                        </tr> 
                                        <?php
