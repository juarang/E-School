		                    ...
		                    <div class="tab-pane active" id="reports">
		                        <div class="element-wrapper">
                                    <h6 class="element-header">
                                        ...
                                        <div class="element-content"><a href="javascript:void(0);" data-target="#addroutine" data-toggle="modal" class="btn btn-control btn-grey-lighter btn-purple"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i><div class="ripple-container"></div></a></div>
                                    </h6>
                                    <div class="element-box-tp">
                                        <div class="table-responsive">
                                            <table class="table table-padded">
			                                    ...
			                                    ?>
                                                    <tr>
                                                        <td><img alt="" src="<?php echo $this->crud->get_image_url('teacher', $row['teacher_id']);?>" width="25px" class="tbl-user"> <?php echo $this->crud->get_name('teacher', $row['teacher_id']);?></td>
					                                    <td><a href="<?php echo base_url();?>student/view_report/<?php echo $row['report_code'];?>" class="text-black"><?php echo $row['title'];?></a></td>
					                                    <td><a class="btn nc btn-rounded btn-sm btn-primary text-white"><?php echo $row['report_code'];?></a></td>
					                                    <td><a class="btn nc btn-rounded btn-sm btn-success text-white"><?php echo $row['timestamp'];?></a></td>
					                                    <td>
                                    					<?php if($row['priority'] == 'alta'):?>
                                    						<a class="btn nc btn-rounded btn-sm btn-danger text-white"><?php echo getEduAppGTLang('high');?></a>
                                    					<?php endif;?>
                                    					<?php if($row['priority'] == 'media'):?>
                                    						<a class="btn nc btn-rounded btn-sm btn-warning text-white"><?php echo getEduAppGTLang('middle');?></a>
                                    					<?php endif;?>
                                    					<?php if($row['priority'] == 'baja'):?>
                                    						<a class="btn nc btn-rounded btn-sm btn-secondary text-white"><?php echo getEduAppGTLang('low');?></a>
                                    						<?php endif;?>
					                                    </td>
					                                    <td>
                                    					<?php if($row['status'] == 0):?>
                                    						<a class="btn nc btn-rounded btn-sm btn-danger text-white" href="#"><?php echo getEduAppGTLang('pending');?></a>
                                    					<?php endif;?>
                                    					<?php if($row['status'] == 1):?>
                                    						<a class="btn nc btn-rounded btn-sm btn-success text-white" href="#"><?php echo getEduAppGTLang('solved');?></a>
                                    					<?php endif;?>
					                                    </td>
					                                    <td class="row-actions">
						                                    <a class="btn btn-rounded btn-sm btn-primary text-white" href="<?php echo base_url();?>student/view_report/<?php echo $row['report_code'];?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i> <?php echo getEduAppGTLang('view');?></</a>
					                                    </td>	
                                                    </tr>
                                                    <?php endforeach;?>
                                                </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ui-block-title mdl-header">
                        <h6 class="title text-white"><?php echo getEduAppGTLang('create_report');?></h6>
                    </div>
