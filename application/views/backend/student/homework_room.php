		                    ...
		                    <div class="pipeline white lined-primary shadow">
			                    ...
			                    <div class="b-t padded-v-big">
			                        <?php echo form_open(base_url() . 'student/delivery/file/'.$homework_code , array('enctype' => 'multipart/form-data'));?>
			                            ...
			                            <div class="row">
			                                <div class="col-sm-12">
                                                <textarea class="form-control full-width" placeholder="<?php echo getEduAppGTLang('send_teacher_comment');?>" name="comment" rows="5"></textarea>
		                        ...
		                        <?php echo form_open(base_url() . 'student/delivery/text/'.$homework_code);?>
		                            <div class="b-t padded-v-big">
		                                ...
		                                <div class="row">
		                                    <div class="col-sm-12">
                                                <textarea class="full-width form-control" placeholder="<?php echo getEduAppGTLang('send_teacher_comment');?>" name="comment" rows="5"></textarea>
