                                ...
                                <div class="friend-item friend-groups">
                                    <div class="friend-item-content">
                                        <div class="friend-avatar">
                                            <div class="author-thumb">
                                                <img src="<?php echo base_url();?>public/uploads/icons/sms.svg" width="110px" class="no-border bg-white padd15">
                                            </div>
                                            <div class="author-content">
                            ...
                            <div class="ui-block" data-mh="friend-groups-item">
                                <div class="friend-item friend-groups">
                                    <div class="friend-item-content">
                                        <div class="friend-avatar">
                                            <div class="author-thumb">
                                                <img src="<?php echo base_url();?>public/uploads/icons/emails.svg" width="110px" class="no-border bg-white padd15">
                                            </div>
                                            <div class="author-content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ui-block-title mdl-header">
                        <h6 class="title text-white"><?php echo getEduAppGTLang('send_emails');?></h6>
                    </div>
                            ...
                            <div class="row">
                                <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group label-floating is-select">
                                        ...
                                        <div class="select">
                                            <select name="class_id" onchange="get_sections(this.value);">
