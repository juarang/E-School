                                                                                ...
                                                                                <div class="friend-item-content">         
                                                                                    <div class="more">
                                                                                        ...
                                                                                        <ul class="more-dropdown">
                                                                                            <li><a href="<?php echo base_url();?>teacher/subject_dashboard/<?php echo base64_encode($row2['class_id']."-".$row['section_id']."-".$row2['subject_id']);?>/"><?php echo getEduAppGTLang('dashboard');?></a></li>
                                                                                        </ul>
                                                                                    </div>
