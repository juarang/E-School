                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if($type == 1 && $row['file_name'] == ""):?>
                        	                            <a class="btn btn-rounded btn-sm btn-secondary" href="<?php echo base_url();?>teacher/single_homework/<?php echo $row['id'];?>" class="text-white"><i class="os-icon picons-thin-icon-thin-0043_eye_visibility_show_visible"></i> <?php echo getEduAppGTLang('view_response');?></a>
                                                    <?php endif;?>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td width="7%">   
                                                        <a class="btn btn-danger btn-sm" href="<?php echo base_url();?>teacher/delete_delivery/<?php echo $row['id'];?>/<?php echo $homework_code;?>" onclick="return confirm('<?php echo getEduAppGTLang('confirm_delete');?>');"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full text-white"></i></a>
                                                    </td>
                                                </tr>
                	                            <?php endforeach;?>
                                            </tbody>
