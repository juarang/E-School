                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-left cell-with-media" >
                                                                    <a href="<?php echo base_url() . 'public/uploads/homework/' . $row['file_name']; ?>"><img src="<?php echo base_url();?>public/uploads/icons/file.svg" class="height25"><span><?php echo $row['file_name'];?></span><span class="smaller">(<?php echo $row['filesize'];?>)</span></a>
                                                                </td>             
                                                            </tr>
                                                        </tbody>
                                                    </table>
