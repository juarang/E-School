				        ...
				        <div class="tab-content">
                            <div class="os-tabs-w bg-white">
                                <ul class="navs navs-tabs upper centered">
                                    <li class="navs-item">
                                        <a class="navs-links text-black <?php if($page_name == 'message' && $message_inner_page_name != 'message_new') echo "active";?>" href="<?php echo base_url();?>teacher/message/"><i class="os-icon picons-thin-icon-thin-0306_chat_message_discussion_bubble_conversation nav-color"></i><span><?php echo getEduAppGTLang('chats');?></span></a>
                                    </li>
                                    <li class="navs-item">
                                    ...
                                    <li class="navs-item">
                                        <a class="navs-links text-black" href="<?php echo base_url();?>teacher/group/"><i class="os-icon picons-thin-icon-thin-0719_group_users_circle nav-color"></i><span><?php echo getEduAppGTLang('groups');?></span></a>
                                    </li>
                                </ul>
                            </div>
                          					...
                          					<?php else:?>
                          					    ...
                          					    <?php endif;?>
                            					    ...
                            					    <?php if($user_to_show_type =='admin') : ?>
                                 						<a class="badge badge-success text-white" href="<?php echo base_url(); ?>teacher/message/message_read/<?php echo $row['message_thread_code']; ?>"><?php echo getEduAppGTLang('admin');?></a>
                           						    <?php endif;?>
                           						    <?php if($user_to_show_type =='student') : ?>
                                 						<a class="badge badge-secondary text-white" href="<?php echo base_url(); ?>teacher/message/message_read/<?php echo $row['message_thread_code']; ?>"><?php echo getEduAppGTLang('student');?></a>
                           						    <?php endif;?>
                           						    <?php if($user_to_show_type =='teacher') : ?>
                                 						<a class="badge badge-warning text-white" href="<?php echo base_url(); ?>teacher/message/message_read/<?php echo $row['message_thread_code']; ?>"><?php echo getEduAppGTLang('teacher');?></a>
                           						    <?php endif;?>
                           						    <?php if($user_to_show_type =='parent') : ?>
                                 						<a class="badge badge-purple text-white" href="<?php echo base_url(); ?>teacher/message/message_read/<?php echo $row['message_thread_code']; ?>"><?php echo getEduAppGTLang('parent');?></a>
                           						    <?php endif;?>
                          					    </div>
                        				    </div>
                      				    </div>
