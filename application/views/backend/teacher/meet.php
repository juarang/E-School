                                            ...
                                            <table class="table table-padded">
                            	                ...
                            	                ?>   
                                                    <tr>
                                                        ...
                                                        <?php else:?>
                                                            <a href="<?php echo base_url();?>teacher/live/<?php echo base64_encode($row['live_id']);?>" class="grey"><span><i class="grey picons-thin-icon-thin-0139_window_new_extern_full_screen_maximize"></i></span></a>
                                                        <?php endif;?>
                                                            <a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_live/<?php echo $row['live_id'];?>');" class="grey"> <span><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i></span> </a>
                                                            ...
                                                            <a class="grey" onClick="return confirm('<?php echo getEduAppGTLang('confirm_delete');?>')" href="<?php echo base_url();?>teacher/meet/delete/<?php echo $row['live_id']?>/<?php echo $data;?>"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach;?>
                                                </tbody>
