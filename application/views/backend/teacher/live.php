                        ...
                        <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="ui-block features-video">
                                <div class="video-player">
                                    ...
                                    <input type="hidden" value="<?php echo $this->db->get_where('teacher', array('teacher_id' => $this->session->userdata('login_user_id')))->row()->email;?>" id="liveEmail">
                                    <input type="hidden" value="<?php echo $this->crud->get_name('teacher', $this->session->userdata('login_user_id'));?>" id="liveDisplay">
                                    <input type="hidden" value="<?php echo $row['room'];?>" id="liveRoom">
                                    <input type="hidden" value="<?php echo $row['title'];?>" id="liveTitle">
                                </div>
                                <div class="features-video-content">
                                    <article class="hentry post">
                                        ...
                                        <ul class="friends-harmonic">
                                            ...
                                            ?>
                                            <li>
                                                <a href="javascript:void(0);" class="left0">
