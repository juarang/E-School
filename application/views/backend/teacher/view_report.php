                            ...
                            <?php if($row['status'] == 0): ?>
                		  	    <div class="row">
                			        ...
                			        <div class="col-sm-12">
                                        ...
                                        <a onclick="submitComment();" class="btn btn-success pull-right text-white" href="javascript:void(0);"><?php echo getEduAppGTLang('reply');?></a><br><br>
                				    </div>
                				</div>
                    	        <?php endif;?>
                    	        <?php if($row['status'] == 1):?>
                                ...
                                ?>
                            		<div class="element-box-w b-t">
                                        <div class="row m-t m-b">
                            			  <div class="col-sm-10">
                            				  <a href="javascript:void(0);"><img alt="" src="<?php echo $this->crud->get_image_url($row2['sender_type'], $row2['sender_id']);?>" width="30px" class="tbl-st"> <b><span class="infogi"><?php echo $this->crud->get_name($row2['sender_type'], $row2['sender_id']);?></span></b></a>
