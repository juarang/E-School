                                            ...
                                            <tr class="brdtp">
					                            ...
					                            <td>
					                                ...
					                                <?php if($mark < $min || $mark == ""):?>
					  	                            <a class="btn nc btn-rounded btn-sm btn-danger text-white"><?php if($mark == "") echo '0'; else echo $mark;?></a>
					                                <?php endif;?>
    					                            <?php if($mark >= $min):?>
					  	                            <a class="btn nc btn-rounded btn-sm btn-success text-white"><?php echo $mark;?></a>
					                                <?php endif;?>
					                            </td>
                                            </tr>	
                                        </tbody>
