                        ...
                        <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="ui-block features-video">
                                <div class="video-player">
                                    ...
                                    <input type="hidden" value="<?php echo $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->email;?>" id="liveEmail">
                                    <input type="hidden" value="<?php echo $this->crud->get_name('admin', $this->session->userdata('login_user_id'));?>" id="liveDisplay">
