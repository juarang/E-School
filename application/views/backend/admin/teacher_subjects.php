          								    ...
          								    <div class="up-main-info">
          								   	    <div class="user-avatar-w">
          								            <div class="user-avatar">
          								                <img alt="" src="<?php echo $this->crud->get_image_url('teacher', $row['teacher_id']);?>" class="bg-white">
              								        </div>
          								        </div>
					                                            ...
					                                            <div class="friend-item-content">
						                                            <div class="friend-avatar"> 
							                                            <div class="author-thumb">
    								                                        <img src="<?php echo base_url();?>public/uploads/subject_icon/<?php echo $subject['icon'];?>" width="120px" class="sb" style="background-color:#<?php echo $subject['color'];?>;">
							                                            </div>
