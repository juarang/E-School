...
?>
    <div class="modal-body">
        <div class="modal-header mdl-header">
            <h6 class="title text-white"><?php echo getEduAppGTLang('update_grade_level');?></h6>
        </div>
        <div class="ui-block-content">
            <?php echo form_open(base_url() . 'admin/grade/update/'.$row['grade_id'] , array('enctype' => 'multipart/form-data'));?>
                ...
                <div class="form-buttons-w">
                    <button class="btn btn-rounded btn-success pull-right" type="submit"> <?php echo getEduAppGTLang('update');?></button><br>
                </div>
            </div>
        </div>
    <?php echo form_close();?>
