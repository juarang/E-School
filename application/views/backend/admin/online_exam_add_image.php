        ...
        <div class="form-group" id='multiple_choice_question'>
            ...
            <div class="col-sm-12">
                <div class="form-group with-icon label-floating is-empty">
    		        ...
    		        <button type="button" class='btn btn-sm bg-white no-border topminus10' name="button" onclick="showOptions(jQuery('#number_of_options').val())"><i class="picons-thin-icon-thin-0154_ok_successful_check topminus35"></i></button>
    		    </div>
            </div>
        </div>
        <div class="form-group">
