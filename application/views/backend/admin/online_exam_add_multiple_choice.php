    <?php echo form_open(base_url() . 'admin/manage_online_exam_question/'.$online_exam_id.'/add/multiple_choice' , array('enctype' => 'multipart/form-data'));?>
        ...
        <input type="hidden" name="type" value="admin" id="uslg">
        ...
        <div class="form-group" id='multiple_choice_question'>
            ...
            <div class="col-sm-12">
                <div class="form-group with-icon label-floating is-empty">
    		        ...
    		        <button type="button" class='btn btn-sm bg-white no-border topminus10' name="button" onclick="showOptionsMultiple(jQuery('#number_of_options').val())"><i class="picons-thin-icon-thin-0154_ok_successful_check topminus35"></i></button>
    		    </div>
            </div>
        </div>
        <div class="form-group">
