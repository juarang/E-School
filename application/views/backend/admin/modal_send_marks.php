    <div class="modal-body">
        <div class="modal-header mdl-header">
            <h6 class="title text-white"><?php echo getEduAppGTLang('send_marks_by_email');?></h6>
        </div>
            ...
            <?php echo form_open(base_url() . 'admin/send_marks/email/', array('enctype' => 'multipart/form-data'));?>
                <div class="row">
                    ...
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                        <button class="btn btn-purple full-width" type="submit"><?php echo getEduAppGTLang('send');?></button>
                    </div>
                </div>
            <?php echo form_close();?>
        </div>
