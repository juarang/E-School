                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="bolder">
                                                            <?php if($row['liveType'] == 2):?>
                                                                <a href="<?php echo $row['siteUrl'];?>" target="_blank" class="grey"><span><i class="grey picons-thin-icon-thin-0139_window_new_extern_full_screen_maximize"></i></span></a>
                                                            <?php else:?>
                                                                <a href="<?php echo base_url();?>admin/live/<?php echo base64_encode($row['live_id']);?>" class="grey"><span><i class="grey picons-thin-icon-thin-0139_window_new_extern_full_screen_maximize"></i></span></a>
                                                            <?php endif;?>
                                                            <a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_live/<?php echo $row['live_id'];?>');" class="grey"> <span><i class="grey picons-thin-icon-thin-0001_compose_write_pencil_new"></i></span> </a>
                                                            <a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_attendance/<?php echo $row['live_id'];?>');" class="grey"> <span><i class="os-icon picons-thin-icon-thin-0023_calendar_month_day_planner_events"></i></span> </a>
                                                            <a class="grey" onClick="return confirm('<?php echo getEduAppGTLang('confirm_delete');?>')" href="<?php echo base_url();?>admin/meet/delete/<?php echo $row['live_id']?>/<?php echo $data;?>"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach;?>
                                                </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ui-block-title mdl-header">
                        <h6 class="title text-white"><?php echo getEduAppGTLang('create_live');?></h6>
                    </div>
        	            ...
        	            <?php echo form_open(base_url() . 'admin/meet/create/'.$data, array('enctype' => 'multipart/form-data')); ?>
	                        <div class="row">
                                ...
                                <div class="col col-lg-12 col-md-12 col-sm-12 col-12 text-center">
                                    ...
                                    <div class="custom-control custom-radio show-inline">
                                ...
                                <div class="col col-lg-12 col-md-12 col-sm-12 col-12 hidde" id="siteUrl">
                            		<div class="form-group">
