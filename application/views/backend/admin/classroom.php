												...
												<div class="profile-section bg-white">
													<div class="control-block-button">
                            							 <a href="javascript:void(0);" class="btn btn-control bg-purple c-btn-purple" data-toggle="modal" data-target="#crearadmin">
															<i class="picons-thin-icon-thin-0001_compose_write_pencil_new px25" title="<?php echo getEduAppGTLang('add');?>"></i>
				                                                ...
				                                                ?>
                                  								<div class="col-sm-6">
			                                                        <div class="ui-block list">
			                                                            <div class="more pull-right mgr-right">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="modal-header mdl-header">
                        <h6 class="title text-white"><?php echo getEduAppGTLang('add');?></h6>
                    </div>
