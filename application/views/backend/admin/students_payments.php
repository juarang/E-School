                                            ...
                                            <table class="table table-padded">
                                                ...
                                                <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="bolder">
                                                            <a href="<?php echo base_url();?>admin/invoice_details/<?php echo $row['invoice_id'];?>/" class="grey"><i class="px20" class="picons-thin-icon-thin-0424_money_payment_dollar_cash" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getEduAppGTLang('view_invoice');?>"></i></a>
