                                                			...
                                                			<div class="ui-block list" data-mh="friend-groups-item">
                                                				<div class="friend-item friend-groups">
                                                					<div class="friend-item-content">
                                                						<div class="friend-avatar">
                                                						    <br><br>
                                                						    <i class="picons-thin-icon-thin-0384_graph_columns_drop_statistics iconcls4"></i>
                                                			...
                                                			<div class="ui-block list" data-mh="friend-groups-item">
                                                				<div class="friend-item friend-groups">
                                                					<div class="friend-item-content">
                                                						<div class="friend-avatar">
                                                						    <br><br>
                                                						    <i class="picons-thin-icon-thin-0406_money_dollar_euro_currency_exchange_cash iconcls2"></i>
                                                			...
                                                			<div class="ui-block list" data-mh="friend-groups-item">
                                                				<div class="friend-item friend-groups">
                                                					<div class="friend-item-content">
                                                						<div class="friend-avatar">
                                                						    <br><br>
                                                						    <i class="picons-thin-icon-thin-0406_money_dollar_euro_currency_exchange_cash iconcls3"></i>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="cell-with-media">
                                                                                        <a href="<?php echo base_url();?>accountant/invoice_details/<?php echo $row['invoice_id'];?>/" class="grey"><img alt="" class="height25" src="<?php echo $this->crud->get_image_url('student', $row['student_id']);?>" height="25px"><span> <?php echo $this->crud->get_name('student', $row['student_id']);?></span></a>
                                                                                    </td>
