                                ...
                                ?>    
                                    <article class="hentry post has-post-thumbnail thumb-full-width">
                                        ...
                                        <div class="control-block-button post-control-button">
                                            <a href="javascript:void(0);" class="controlsbt btn btn-control" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getEduAppGTLang('news');?>">
                                ...
                                <?php if($query->num_rows() <= 0):?>
                                    <div class="ui-block paddingtel">
                                        ...
                                        <article class="hentry post">
                                            ...
                                            <div class="control-block-button post-control-button">
                                                <a href="javascript:void(0);" class="grbg2 text-white btn btn-control" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getEduAppGTLang('polls');?>">
                                    ...
                                    <div class="sidebar__inner">
                                        ...
                                        <div class="ui-block paddingtel">
                                            ...
                                            <center>
                                                ...
                                                <a href="<?php echo base_url();?>accountant/birthdays/" class="birthdays-btn"><?php echo getEduAppGTLang('view_all_birthdays');?></a>
                                            </center>
                                            <div class="header-spacer"></div>
                                        </div><br>
                                        <br>
    ...
    <script src="<?php echo base_url();?>public/style/js/accountant_panel.js"></script>