...
?>
                    ...
                    <div class="chat-message-content-w">
                        <div class="chat-message-content">
                            ...
                            <?php if($row['file_name'] != ""):?><br>
                                <a class="text-white badge badge-primary" target="_blank" href="<?php echo base_url();?>public/uploads/messages/<?php echo $row['file_name'];?>"> &nbsp;&nbsp;<?php echo $row['file_name']; ?></a>
                            <?php endif;?>
                        </div>
                    </div>
                        ...
                        <div class="chat-message-content-w">
                            <div class="chat-message-content">
                                ...
                                <?php if($row['file_name'] != ""):?>
                                    <a class="badge badge-primary text-white" target="_blank" href="<?php echo base_url();?>public/uploads/messages/<?php echo $row['file_name']; ?>">&nbsp;&nbsp;<?php echo $row['file_name']; ?></a>
                                <?php endif;?>
                            </div>
                        </div>
                        <div class="chat-message-date">
            ...
            <?php echo form_open(base_url() . 'accountant/message/send_reply/' . $current_message_thread_code, array('enctype' => 'multipart/form-data')); ?>
                ...
                <div class="chat-input-extra">
                    <div class="chat-extra-actions">
                        <input type="file" name="file_name" id="file-3" class="inputfile inputfile-3 hidde"/>
    ...
    <div class="full-chat-right">
        <div class="user-intro">
            <div class="avatar">
                <img alt="" src="<?php echo base_url();?>public/uploads/<?php echo $this->db->get_where('settings', array('type' => 'logo'))->row()->description;?>" class="no-border">
            </div>
                    ...
                    <?php if($img['file_type'] == "png" || $img['file_type'] == "jpg" || $img['file_type'] == "JPEG" || $img['file_type'] == "GIF"):?>
    					<li>
						    <a href="<?php echo base_url();?>public/uploads/messages/<?php echo $img['file_name']; ?>">
    						    <img src="<?php echo base_url();?>public/uploads/messages/<?php echo $img['file_name']; ?>" class="attached-file">
						    </a>
						</li>
					<?php endif;?>
				    <?php endforeach;?>
